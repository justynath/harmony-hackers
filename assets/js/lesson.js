...
const flashcards = [
  ...
  { src: "assets/flashcards/c-sharp-1.png", card: "C#1", alt: "c-sharp-1" },
  { src: "assets/flashcards/d-flat-1.png", card: "C#1", alt: "d-flat-1" },
  { src: "assets/flashcards/d-1.png", card: "D1", alt: "d-1" },
  { src: "assets/flashcards/d-sharp-1.png", card: "D#1", alt: "d-sharp-1" },
  { src: "assets/flashcards/e-flat-1.png", card: "D#1", alt: "e-flat-1" },
  { src: "assets/flashcards/e-1.png", card: "E1", alt: "e-1" },
  { src: "assets/flashcards/f-1.png", card: "F1", alt: "f-1" },
  { src: "assets/flashcards/f-sharp-1.png", card: "F#1", alt: "f-sharp-1" },
  { src: "assets/flashcards/g-flat-1.png", card: "F#1", alt: "g-flat-1" },
  { src: "assets/flashcards/g-1.png", card: "G1", alt: "g-1" },
  { src: "assets/flashcards/g-sharp-1.png", card: "G#1", alt: "g-sharp-1" },
  { src: "assets/flashcards/a-flat-1.png", card: "G#1", alt: "a-flat-1" },
  { src: "assets/flashcards/a-1.png", card: "A1", alt: "a-1" },
  { src: "assets/flashcards/a-sharp-1.png", card: "A#1", alt: "a-sharp-1" },
  { src: "assets/flashcards/b-flat-1.png", card: "A#1", alt: "b-flat-1" },
  { src: "assets/flashcards/b-1.png", card: "B1", alt: "b-1" },
  { src: "assets/flashcards/c-2.png", card: "C2", alt: "c-2" },
  { src: "assets/flashcards/c-sharp-2.png", card: "C#2", alt: "c-sharp-2" },
  { src: "assets/flashcards/d-flat-2.png", card: "C#2", alt: "d-flat-2" },
  { src: "assets/flashcards/d-2.png", card: "D2", alt: "d-2" },
  { src: "assets/flashcards/d-sharp-2.png", card: "D#2", alt: "d-sharp-2" },
  { src: "assets/flashcards/e-flat-2.png", card: "D#2", alt: "e-flat-2" },
  { src: "assets/flashcards/e-2.png", card: "E2", alt: "e-2" },
  { src: "assets/flashcards/f-2.png", card: "F2", alt: "f-2" },
  { src: "assets/flashcards/f-sharp-2.png", card: "F#2", alt: "f-sharp-2" },
  { src: "assets/flashcards/g-flat-2.png", card: "F#2", alt: "g-flat-2" },
  { src: "assets/flashcards/g-2.png", card: "G2", alt: "g-2" },
  { src: "assets/flashcards/g-sharp-2.png", card: "G#2", alt: "g-sharp-2" },
  { src: "assets/flashcards/a-flat-2.png", card: "G#2", alt: "a-flat-2" },
  { src: "assets/flashcards/a-2.png", card: "A2", alt: "a-2" },
  { src: "assets/flashcards/a-sharp-2.png", card: "A#2", alt: "a-sharp-2" },
  { src: "assets/flashcards/b-flat-2.png", card: "A#2", alt: "b-flat-2" },
...
document.getElementById('how-to-play').addEventListener('click', () => {
  alert('Match the note displayed with the correct piano key. You have 2 minutes to score as many correct answers as possible!');
});
